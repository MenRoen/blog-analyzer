...
const REGION_CODES = {
    ...
    "부산 연제구": "26470", "부산 수영구": "26500", "부산 사상구": "26530", "기장군": "26710",
    // 대구
    "대구 중구": "27110", "대구 동구": "27140", "대구 서구": "27170", "대구 남구": "27200",
    "대구 북구": "27230", "대구 수성구": "27260", "대구 달서구": "27290", "달성군": "27710",
    // 광주
...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        if (regionCode) {
            // 실제 데이터가 있는 최근 3개월 조회 (2024년 기준)
            const baseDate = new Date('2024-12-01'); // 2024년 12월 기준
                        ...
                        if (resultCode && (resultCode[1] === '00' || resultCode[1] === '000')) {
                            ...
                            rentItems.forEach(itemXml => {
                                ...
                                if (aptName && dong) {
                                    ...
                                    apartments[key].rents = apartments[key].rents || [];
